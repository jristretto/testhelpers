...
public class TestHelpers {
    ...
    public static void assertFinal( String msg, Field field ) {
        _assertTrue( msg, Modifier.isFinal( field.getModifiers() ) );
    }
    ...
    public static <T> void testEqualsAndHashCode( T ref, T equal, T... unEqual ) {
        ...
        _assertTrue( "hashcode of equal objects should be same", ref.hashCode() == equal.hashCode() );
    }

    static void _assertEquals( String string, Object expected, Object actual ) {
    ...
    static void _assertTrue( String message, boolean boolValue ) {
        if ( !boolValue ) {
    ...
    static void _assertFalse( String message, boolean boolValue ) {
        if ( boolValue ) {
            throw new AssertionError( message );
        }
    }

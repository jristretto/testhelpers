...
import static io.github.jristretto.testhelpers.NFTestHelpers.assertParameterBoundsDeclaration;
import static io.github.jristretto.testhelpers.NFTestHelpers.assertParameterIsReceiver;
import static io.github.jristretto.testhelpers.NFTestHelpers.assertParameterIsSupplier;
...
public class MethodParamsTest {
    ...
    public void testSuper() throws NoSuchMethodException {
        ...
        assertThat( param1GenericDecl ).contains( "? super io.github.jristretto.testhelpers.Car" );
//        fail( "stop" );
    }
    ...
    public void testAssertBoundsDeclaration() throws NoSuchMethodException {
        ...
        Method methodM = cClass.getDeclaredMethod( "m", List.class );
        try {
            assertParameterBoundsDeclaration( methodM, 0, "? super io.github.jristretto.testhelpers.Car" );
        } catch ( Throwable t ) {
